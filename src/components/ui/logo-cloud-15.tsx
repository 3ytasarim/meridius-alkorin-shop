...
const LogoCloud = () => {
  ...
  return (
    <div className="flex items-center justify-center px-6 py-16 lg:py-24">
      <div
        className="relative w-full max-w-(--breakpoint-xl) rounded-lg border"
        ref={cardRef}
      >
        <BorderBeam
        ...
        <div className="absolute inset-x-0 top-0 flex -translate-y-1/2 items-center justify-center px-10">
          <p
            className="bg-background px-3 text-center font-medium text-navy/80 text-xl tracking-[-0.01em] sm:px-6"
            ref={textRef}
          >
            <span
              ref={waveSpanRef}
              style={{
                ...
                // Alkorin-Palette: Gesundheits-Gelb / Gesundheits-Blau statt Orange/Violett.
                backgroundImage:
                  "linear-gradient(90deg, currentColor 0%, currentColor 45%, #E9CD7F 47%, #5B9FB5 50%, #E9CD7F 53%, currentColor 55%, currentColor 100%)",
            ...
            >
              ...
              <span className="max-sm:hidden">deinen Händlern</span>
            </span>
          </p>
        </div>
